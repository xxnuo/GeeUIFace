...
public class RGestureConsts {
     ...
     * 找人执行完毕，关闭
     */
    public static final int GESTURE_SEARCH_PEOPLE_RESULT_CLOSE = 1019;
    public static final int GESTURE_NEW_ROBOT_POSE = 1020;
    /**
     * 远程漫步姿态执行完成
     */
    public static final int GESTURE_REMOTESTROLL = 1021;
    /**
     * 找人开始之后延时没有结果则自动结束
     */
    public static final int GESTURE_SEARCH_PEOPLE_START_DELAY_STOP = 1022;
     ...
     * 解除绑定
     */
    public static final int GESTURE_ID_REST_BIND = 3108;

    /**
     * 自我介绍姿态
     */
    public static final int GESTURE_ID_SELF_NTRODUCTION = 3109;
}
